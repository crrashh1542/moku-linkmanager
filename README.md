# Moku 友链管理器
![插件版本](https://img.shields.io/badge/plugin-v2.4.4-blue)
...
## 后端
![后端稳定版本](https://img.shields.io/badge/stable-v2.4.4.240124-blue)
![后端最新版本](https://img.shields.io/badge/latest-v2.4.4.240124-blue)   
